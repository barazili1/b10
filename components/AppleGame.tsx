                    ...
                    >
                            ...
                            <div className={`px-2.5 py-1 rounded-lg text-[10px] font-bold flex items-center gap-1 transition-all ${
                                ...
                                {promoCopied ? (
                                    ...
                                    <>
                                        ...
                                        <span>{language === 'ar' ? 'نسخ B10' : 'Copy B10'}</span>
                                    </>
                                )}
                            </div>
                        </div>
                        ...
                        <div className="flex flex-col w-full gap-2.5">
                            <motion.button 
                                ...
                                onClick={() => {
                                    playSound('click');
                                    window.open(platform === 'linebet_v1' ? 'https://refpa79184.com/L?tag=d_5848868m_188307c_&site=5848868&ad=188307' : 'https://goobet.com', '_blank');
                                }}
